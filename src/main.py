...
def write_in_history(operation_number: int, currency1: str, time1: str, currency2: str, time2: str, different: float) -> None:
...
with dpg.window() as main_window:
    ...
    dpg.add_text('\n')
    time_to_check = dpg.add_input_text(label='check time(sec)', tag='time_to_check')
